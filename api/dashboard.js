const BASES = {
  default: {
    BASE_ID:  'appGpHtfRJqefTEbh',
    TABLE_ID: 'tblPISPaN0lPJIekJ',
    TOKEN:    process.env.AIRTABLE_TEST_FELICIDAD
  },
  caintra: {
...
export default async function handler(req, res) {
  ...
  try {
    const url = `https://api.airtable.com/v0/${config.BASE_ID}/${config.TABLE_ID}/${recordId}`;
